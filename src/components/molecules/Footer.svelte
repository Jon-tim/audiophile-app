...
<footer class="bg-dark">
	<section class="max-w-5xl mx-auto flex flex-col gap-10 pb-8 px-6 md:px-10 lg:gap-16 lg:px-0">
		<div
			class="flex flex-col items-center gap-8 w-full md:items-start lg:flex-row lg:justify-between lg:items-end"
		>
		...
		<div class=" flex flex-col items-center gap-10 w-full lg:flex-row lg:justify-between">
			...
			<div class="w-full flex items-center justify-center gap-6 md:justify-start lg:justify-end">
				<div>
		...
		<div class="">
			<p class="text-white/70 text-center capitalize text-sm lg:text-start">
