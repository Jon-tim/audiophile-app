...
<nav
	class="bg-dark px-6 md:px-10 lg:px-0 relative w-full top-0 z-20 border-b-[1px] border-white/20 md:border-none"
>
	<Mobile />
	<section
	...
	>
		...
		<DesktopNavLinks />
		<!-- cart svg -->
		<svg width="23" height="20" class="cursor-pointer group" xmlns="http://www.w3.org/2000/svg"
			><path
